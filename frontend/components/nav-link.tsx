...
export default function NavLink({
  ...
  if (isLogin) {
    return (
      <Link
        href={href}
        className="relative inline-flex items-center justify-center px-4 py-1 text-xs tracking-[0.2em] uppercase text-sbi-green border border-sbi-green/30 hover:bg-sbi-green hover:text-sbi-dark transition-all duration-300"
      >
        {name}
      </Link>
    );
