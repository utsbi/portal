...
export function ReportsOverview({ reports }: ReportsOverviewProps) {
    ...
    const filteredReports = useMemo(() => {
        return reports.filter(r => {
            const matchesDept = filterDept === "All Depts" || r.department === filterDept;
            ...
            if (filterTime !== "All Time") {
                ...
                if (filterTime === "This Week") {
                    ...
                    matchesTime = date >= startOfLastMonth && date < startOfThisMonth;
                }
            }
    ...
    const stats = useMemo(() => {
        ...
        const denied = filteredReports.filter((r) => r.status === "Denied").length;
    ...
    const statusData = useMemo(() => [
        { name: "Done", value: stats.done, color: "#22c55e" }, // sbi-green
        { name: "In Progress", value: stats.inProgress, color: "#60a5fa" }, // blue-400
        { name: "Pending", value: stats.pending, color: "#fbbf24" }, // amber-400
        { name: "Denied", value: stats.denied, color: "#f87171" }, // red-400
    ...
    const departmentData = useMemo(() => {
        ...
        return Object.entries(counts)
            ...
            .sort((a, b) => b.count - a.count) // Sort by most active
            .slice(0, 5); // Top 5
    }, [filteredReports]);

    // Timeline (Area Chart) - Reports by Month
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={timelineData}>
                                ...
                                <Tooltip
                                    ...
                                    itemStyle={{ color: "#fff" }}
                                />
                                <Area type="monotone" dataKey="count" stroke="#22c55e" fillOpacity={1} fill="url(#colorCount)" strokeWidth={2} />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </div>
...
// Simple icons for headers if not imported
