...
class DocumentMetadata(BaseModel):
    ...
    upload_date: Optional[str] = Field(
        default=None, description="ISO format upload timestamp"
    )
    total_pages: Optional[int] = Field(
        default=None, description="Total pages in the original document"
    )
...
class DocumentUploadResponse(BaseModel):
    ...
    document_ids: List[str] = Field(
        default=[], description="IDs of created document chunks"
    )
...
class DocumentListItem(BaseModel):
    ...
    upload_date: Optional[str] = Field(
        default=None, description="When the document was uploaded"
    )
    total_pages: Optional[int] = Field(default=None, description="Number of pages")
    chunk_count: Optional[int] = Field(
        default=None, description="Number of chunks stored"
    )
