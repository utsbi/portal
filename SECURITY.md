...
- **Stored credentials** — Google OAuth tokens for the dashboard calendar/contact integrations.
- **Database access** — Supabase row-level security (RLS) policies guarding tenant data.
- **Public surface** — the marketing/contact pages and any unauthenticated API routes.
